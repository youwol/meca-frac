    ...
    return (
        ...
        >
            <div>
                ...
                <div>
                    <p>
                        Opening mode fractures form in the plane perpendicular
                        to the least compressive principal stress direction, σ3.
                        The most common opening mode fractures are the joints
                        but veins (tension gashes) and dikes are also included.
                    </p>
                </div>
            </div>
        </RangeSlider>
                ...
                <div className={'d-flex w-100'}>
                    ...
                    <div
                        ...
                        onClick={(ev) => {
                            ...
                            createDivAtCursor({
                                children: (
                                    <CircleContainer onClick={handleMinColor} />
                                ),
                                event: ev,
                            })
                        }}
                    ...
                    <div
                        ...
                        onClick={(ev) => {
                            ...
                            createDivAtCursor({
                                children: (
                                    <CircleContainer onClick={handleMaxColor} />
                                ),
                                event: ev,
                            })
                        }}
...
function createSynchronizedColorGradientWithWhiteBlack(
    ...
    if (startHue <= endHue) {
        ...
        for (let i = 0; i < numColors; i++) {
            const hue =
                (startHue +
                    ((endHue - startHue + 360) % 360) * (i / (numColors - 1))) %
                360
            hues.push(hue)
        }
    }
